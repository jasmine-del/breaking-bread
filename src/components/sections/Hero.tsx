...
export function Hero() {
  return (
    <section id="hero" className="relative w-full overflow-hidden pt-24 md:pt-36 pb-0">
      ...
      <div className="relative container mx-auto max-w-6xl px-4 grid grid-cols-1 md:grid-cols-[1.1fr_1fr] items-center gap-10 md:gap-8">
        <div className="relative flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <Wordmark className="w-60 sm:w-72 md:w-[400px] lg:w-[460px] h-auto animate-rise" />
          <p className="text-base md:text-lg text-[var(--color-brand-gray)] leading-relaxed mt-5 md:mt-7 mb-7 md:mb-9 max-w-md animate-rise [animation-delay:150ms]">
            {heroData.subheadline}
          </p>
          <div className="flex flex-col items-center md:items-start gap-3 animate-rise [animation-delay:300ms]">
        ...
        <div className="relative w-64 sm:w-72 md:w-[420px] aspect-[4/5] mx-auto animate-scale [animation-delay:200ms]">
          ...
          <HeroShowcase />
          {/* spinning badge */}
          <div className="absolute -left-4 md:-left-10 bottom-4 md:bottom-6 w-16 h-16 md:w-24 md:h-24 animate-slow-spin">
          ...
          <div className="absolute -top-3 -right-2 md:-right-4 animate-rise [animation-delay:500ms]">
          ...
          <div className="absolute -left-4 md:-left-8 top-8 animate-rise [animation-delay:650ms]">
            <div className="relative w-16 h-16 md:w-24 md:h-24 rounded-full overflow-hidden ring-4 ring-white shadow-lg animate-float [animation-delay:1.2s]">
              <Image src="/bake-9.jpg" alt="Lemon cream tart" fill sizes="96px" className="object-cover" />
            </div>
          </div>
          <div className="absolute -right-2 md:-right-6 bottom-24 animate-rise [animation-delay:800ms]">
            <div className="relative w-14 h-14 md:w-20 md:h-20 rounded-full overflow-hidden ring-4 ring-white shadow-lg animate-float [animation-delay:2.4s]">
      ...
      <div className="relative mt-10 md:mt-16 border-y border-[var(--color-brand-choco)]/10 py-3 overflow-hidden">
