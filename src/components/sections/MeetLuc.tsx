...
export function MeetLuc() {
  return (
    <section id="about" className="w-full py-12 md:py-20 px-4 bg-[var(--color-brand-pale)]/50">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold font-serif tracking-tight text-[var(--color-brand-choco)] mb-1">
          {lucData.name}
        </h2>
